...
class DbLoad extends StatefulWidget {
  Directory dbDir;
  DbLoad({required this.dbDir, Key? key}) : super(key: key);

  @override
  State<DbLoad> createState() => _DbLoadState();
}

class _DbLoadState extends State<DbLoad> {
  ...
  Future<List<Items>> fetchItems(BuildContext context) async {
    ...
    //print(temp);
    //print(tempTypes);
    //print(tempTypes.first.values.last.toString());
    var itemslisttemp2 =
